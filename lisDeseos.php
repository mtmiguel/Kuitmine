...
<!DOCTYPE html>
<html lang="en" id="lisDeseosHTML" typeu="<?php echo $tipoUser ?>">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Lista de Deseos</title>
        <link rel="stylesheet" href="estilos\lisDeseos.css">
        <input type="hidden" class="class1LiDeseos" value="<?php echo $tipoUser?>">
    </head>
    <body class="body">
        ...
        <main>
            <div class="conteintMensaje">
                ...
                <p class="parrafo">La <span>lista de Deseos y Regalos</span> estará disponible para versiones posteriores a la <span>0.5</span></p>
